...
if DB_ENGINE == "postgresql":
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('POSTGRES_DB', 'victorinka_db'),
            'USER': os.getenv('POSTGRES_USER', 'victorinka_user'),
            'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'victorinka_pass'),
...
EMAIL_BACKEND = os.getenv(
    'EMAIL_BACKEND',
    'django.core.mail.backends.console.EmailBackend'  # По умолчанию вывод в консоль
)
...
SITE_NAME = os.getenv('SITE_NAME', 'Victorinka Quiz Platform')
